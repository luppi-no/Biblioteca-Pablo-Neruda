                        ...
                        <asp:GridView ID="gvUsuarios" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="intIDArea" HeaderText="IDArea" 
                                    ConvertEmptyStringToNull="False" NullDisplayText="Por Asignar">
                                    <HeaderStyle CssClass="hide" />
                                    <ItemStyle CssClass="hide" />
                                </asp:BoundField>
                            ...
                            <div class="body">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvArea" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuario"
                                                ControlToValidate="ddlArea" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                        ...
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvCargos" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuario"
                                                ControlToValidate="ddlCargos" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                        ...
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvCentro" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuario"
                                                ControlToValidate="ddlCentro" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                        ...
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvFormulario" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuario"
                                                ControlToValidate="ddlFormulario" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="body">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvAreaE" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuarioE"
                                                ControlToValidate="ddlAreaE" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                        ...
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvCargosE" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuarioE"
                                                ControlToValidate="ddlCargosE" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                        ...
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvCentroE" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuarioE"
                                                ControlToValidate="ddlCentroE" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                        ...
                                        <td style="width: 75%">
                                            <asp:DropDownList ID="ddlFormularioE" runat="server" Width="100%">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 5%">
                                        <asp:RequiredFieldValidator ID="rfvFormularioE" runat="server" ErrorMessage="(*)" ValidationGroup="vgUsuarioE"
                                                ControlToValidate="ddlFormularioE" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" style="width: 100%">
