        ...
        <asp:UpdatePanel ID="upCapacitarEvaluado" runat="server" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pCapacitacion" runat="server" Style="display: none" CssClass="modalPopup">
                    ...
                    <div class="footer">
                        <asp:Button ID="btnCerrarCapacitaciones" runat="server" Text="Cancelar" class="btn btn-default"
                            OnClick="btnCerrarCapacitaciones_Click" />
                        <asp:Button ID="btnGuardarCapacitaciones" runat="server" Text="OK" class="btn btn-primary"
