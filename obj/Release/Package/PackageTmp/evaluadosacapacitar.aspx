<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true"
    CodeBehind="evaluadosacapacitar.aspx.cs" Inherits="Proyecto.evaluadosacapacitar" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    EMIN - Evaluados a Capacitar
</asp:Content>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="capacitaciones">
                ...
                <div align="center">
                    <p class="title">
                        Evaluados a capacitar por periodo</p>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbDetalleEvaluacion" runat="server" CausesValidation="False"
                                            ...
                                            ToolTip="Ver Detalle del Evaluado"><span class="icon-pencil"></span></asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle Width="2%" />
