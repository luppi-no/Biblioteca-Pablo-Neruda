...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    <div class="tabbable">
        <ul class="nav nav-tabs">
            ...
            <li><a href="mail.aspx"><span class="icon-list"></span>&nbsp;Correos Personalizados</a></li>
            <li class="active"><a href="#correosmasivos" data-toggle="tab"><span class="icon-list">
            </span>&nbsp;Correos Masivos</a></li>
        </ul>
